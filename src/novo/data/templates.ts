...
export const TEMPLATES: TemplateInfo[] = [
  ...
  },
  {
    ...
    emoji: '⚖️',
    description: 'Set a goal weight and a target date, then get there your way — log workouts, weigh-ins, or meals, whichever actually works for you. Your journey pet evolves with every step forward.',
    features: [
      'Goal weight & pace projection',
      'Body measurements (waist, chest, hips & more)',
      'Exercise logging',
      'BMI & weight trend',
      '3 mini-games to earn XP',
      'Evolving pet creature (10 stages)',
