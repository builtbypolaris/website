...
import {
  ...
  savePetCharacter as dbSaveCharacter,
  addXP, todayStr,
} from '../lib/storage'
...
export default function Pet() {
  ...
  const applyXP = (xpGain: number, patch: Partial<PetData>) => {
  ...
  return (
    <div className="h-full flex flex-col" style={{ background: '#F5F4F2' }}>
      ...
      >
        ...
        <div className="font-nunito font-bold text-[#09090F] text-sm md:text-base">🐾 Pet Care</div>
              ...
              {pet && (
                <>
                  ...
                  {todayEvents.length > 0 && (
                    <div className="rounded-xl p-4 md:p-5" style={{ background: CARD_BG, border: `1px solid ${CARD_BORDER}` }}>
                      <div className="text-xs font-nunito font-bold uppercase tracking-widest mb-3" style={{ color: ACCENT }}>Today's Care</div>
                  ...
                  {data.careItems.map(item => {
                    ...
                    return (
                      <div
                        ...
                        style={{ background: CARD_BG, border: `1px solid ${item.done ? GOOD_COLOR + '60' : overdue ? '#FCA5A5' : CARD_BORDER}` }}
                      >
                        <button
            ...
            <div className="space-y-4">
              {!pet ? (
                ...
                <>
                  ...
                  {data.pets.length > 0 && (
                    <div className="rounded-xl p-4" style={{ background: CARD_BG, border: `1px solid ${CARD_BORDER}` }}>
                      <div className="text-xs font-nunito font-bold uppercase tracking-widest mb-2" style={{ color: ACCENT }}>Manage</div>
                      <button
