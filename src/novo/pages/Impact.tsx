    ...
    <div className="h-full overflow-y-auto p-5 md:p-8 lg:p-12" style={{ background: '#F5F4F2' }}>
      <div className="max-w-4xl">
        ...
        <div className="mb-8">
          ...
          <p className="font-nunito text-sm max-w-xl" style={{ color: MUTED }}>
        ...
        {cause && causeInfo ? (
          <Panel accent={panelAccent} tone="fill" className="p-6 mb-8">
          ...
          <Panel tone="tint" accent={INK} className="p-6 mb-8">
        ...
        <div className="grid lg:grid-cols-2 gap-x-10 gap-y-8 mb-8">
