...
export const en = {
  ...
  studios: {
    ...
    impact: {
      sticker: 'New · Missions & Crowns',
      titleLine1: 'You track.',
      titleLine2Em: 'We plant.',
      subtitle: 'Complete weekly missions to earn crowns 👑. Pick your cause, and Polaris turns every crown into real impact — fulfilled monthly.',
